...
import { Search, Bell, Home, Workflow, BarChart3, Settings, Database, ArrowRight } from "lucide-react"
...
const navigation = [
  ...
  { name: "Raw Materials", href: "/materials", icon: Database },
      ...
      <header className="h-16 border-b border-gray-200 bg-white px-6 flex items-center justify-between">
        <div className="flex items-center gap-4">
          <div className="flex items-center gap-2">
            ...
            <span className="font-semibold text-gray-900">Gifts N Glimmers</span>
          </div>
                ...
                return (
                  <Link
                    ...
                    className={`flex items-center w-full justify-start px-3 py-2 rounded-md text-sm font-medium transition-colors ${
                      isActive ? "bg-amber-50 text-amber-700 hover:bg-amber-100" : "text-gray-600 hover:bg-gray-50"
                    }`}
                  >
